...
board has its own short tour of the pipeline. Launch it from the dock,
from Settings, or by opening any page with `?tour=1`.
...
![Run board for a completed course with export controls and guide preview (previous visual revision)](docs/screenshots/run-board-complete.png)
