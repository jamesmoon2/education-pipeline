...
To resume: COMPLETE. All 16 tasks done; final whole-branch review passed 2026-07-10 (242 pytest, 41 web tests, build clean, e2e 2/2, plus manager's browser-driven overwrite-confirm/double-export and download-content check). Branch ready to merge — PR #2: https://github.com/jamesmoon2/education-pipeline/pull/2.
