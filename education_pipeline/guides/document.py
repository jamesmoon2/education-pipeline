...
def assemble_guide_document(guide: Guide, assets: RuntimeAssets | None = None, mode: DocumentMode = "export") -> str:
    ...
    course_controls = (
        ...
        f'</label>'
        f'<fieldset class="print-mode-control" data-role="print-mode">'
        f'<legend>Print</legend>'
        f'<label><input type="radio" name="print-mode" value="answer-key" checked> Answer key</label>'
        f'<label><input type="radio" name="print-mode" value="learner-copy"> Learner copy</label>'
        f'</fieldset>'
        ...
        f'<p class="keyboard-help" data-role="keyboard-help">Keyboard: ← and → move between sections, / jumps to the course navigation.</p>'
